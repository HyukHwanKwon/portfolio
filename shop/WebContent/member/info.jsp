...
<body style="font-family: 'Do Hyeon', sans-serif;">
	...
	<center>
		<h2 style="font-family: 'Do Hyeon', sans-serif;">회원 정보</h2>
		<br/>
		<table>
			<form action="memberUpdate.mem" method="post">
				...
				<tr>
					...
					<td>비밀번호 : <input type="password" name="m_pw" id="m_pw" value="${member.memberPassword}"></td>
				</tr>
				<tr>			
					<td>전화번호 : <input type="text" name="m_phone" id="m_phone" value="${member.memberPhone}"></td>
				</tr>
				<tr>			
		...
		<input type="submit" value="정보수정" style="background-color:transparent;" onMouseover="this.style.color='#007bff';" onMouseout="this.style.color='black';">
		<br/>
		<br/>
		<h2 style="font-family: 'Do Hyeon', sans-serif;">회원 탈퇴</h2>
		<form action="memberDelete.mem" method="post">
			<span>비밀번호를 입력하세요 : <input type="password" id="password" name="password"></span>
			<p></p>
			<input type="submit" value="탈퇴하기" style="background-color:transparent;" onMouseover="this.style.color='#007bff';" onMouseout="this.style.color='black';">
		</form>
	</center>
	</br>
	</br>
