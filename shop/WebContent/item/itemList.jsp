	...
	<center>
		...
		<table border="1">
				...
				<tr>
					...
					<td><a href="itemDetail.item?num=${itemList.itemNum}">${itemList.itemPrice}원</a></td>
					<td><a href="itemDetail.item?num=${itemList.itemNum}"><img src="uploadFolder/${itemList.itemImage}" style="width: 164px; height: 100px;"></a></td>
				    <td>
				    	<a href="#" class="button-w3ls active mt-5" style="display: inline;" onclick="buy()">구매</a> 
				    	<a href="cartRegist.cart?num=${itemList.itemNum}&id=${id}" class="button-w3ls active mt-5" style="display: inline;">장바구니</a>
				    </td>
			 	</tr>	
				</c:forEach>
		</table>
