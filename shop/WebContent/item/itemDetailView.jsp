...
<body style="font-family: 'Do Hyeon', sans-serif;">
	...
	<center>
		<h2 style="font-family: 'Do Hyeon', sans-serif;">${itemInfo.itemName} 상세보기</h2>
		<br>
		<div style="display: flex;">
			<div style="display:inline-block; margin-left: auto;">
				<img src="uploadFolder/${itemInfo.itemImage}" style="width: 300px; height: 300px;">
			</div>
			<div style="margin-right: auto;">
				<table border="1" style="height: 300px; width: 400px;">
					...
					<tr>
						...
						<td align="center">${itemInfo.itemPrice}원</td>
					</tr>
					<tr>
				...
				<center>
					...
					<a href="cartRegist.cart?num=${itemInfo.itemNum}&id=${id}" class="button-w3ls active mt-5" style="display: inline;">장바구니</a>
				</center>
			</div>
		</div>
	</center>
