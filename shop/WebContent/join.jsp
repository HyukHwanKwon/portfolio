...
<body style="font-family: 'Do Hyeon', sans-serif;">
	...
	<center>
		<h2 style="font-family: 'Do Hyeon', sans-serif;">회원 가입</h2>
		<br/>
		<form action="memberJoin.mem" method="post">
			...
			<br/>
			<p>전화번호 : <input type="text" name="phone" id="phone"></p>
			<br/>
			<p>이메일 : <input type="email" name="email" id="email"></p>
			<br/>
			<input type="submit" value="가입하기" style="background-color:transparent;" onMouseover="this.style.color='#007bff';" onMouseout="this.style.color='black';">
		</form>
	</center>
	<br/>
	<br/>
