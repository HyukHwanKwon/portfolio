...
<body style="font-family: 'Do Hyeon', sans-serif;">
	...
	<center>
		<h2 style="font-family: 'Do Hyeon', sans-serif;">리뷰 작성하기</h2>
		<br/>
  		<form action="boardRegistForm.bo" method="post"  enctype="multipart/form-data">  
			<table>
				...
				<tr>
					<th>내용 : </th>
					<td><textarea cols="50" rows="10" id="boardContent" name="boardContent"></textarea></td>	
				</tr>
				<tr>
				<th>이미지 : </th>
			...
			<br/>
			<center>
				<input type="submit" value="작성하기" style="background-color:transparent;" onMouseover="this.style.color='#007bff';" onMouseout="this.style.color='black';">
			</center>
  		</form>
	</center>
	</br>
