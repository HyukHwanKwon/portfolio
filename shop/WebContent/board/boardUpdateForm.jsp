...
<body style="font-family: 'Do Hyeon', sans-serif;">
	...
	<center>
		<h2 style="font-family: 'Do Hyeon', sans-serif;">리뷰 수정하기</h2>
		<br/>
 		<form action="boardUpdate.bo" method="get">  
			<table>
				...
				<tr>
					<th>내용 : </th>
					<td><textarea cols="50" rows="10" id="boardContent" name="boardContent" >${boardInfo.boardContent}</textarea></td>	
				</tr>
				<tr>
					<th>이미지 : </th>
					<td><img src="uploadFolder/${boardInfo.boardImage}" style="width: 200px; height: 200px;"></td>	
					<td><input type="hidden" id="boardImage" name="boardImage" value="${boardInfo.boardImage}"></td>	
				</tr>
				</tr>
			</table>
			<br/>
			<center>
				<input type="submit" value="수정하기" style="background-color:transparent;" onMouseover="this.style.color='#007bff';" onMouseout="this.style.color='black';">
			</center>
		</form>	
	</center>
	</br>
