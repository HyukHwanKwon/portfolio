...
<body style="font-family: 'Do Hyeon', sans-serif;">
	...
	<center>
		<h2 style="font-family: 'Do Hyeon', sans-serif;">리뷰 상세</h2>
		<br/>
  		<form action="boardDetailForm.bo" method="post"  enctype="multipart/form-data">  
			...
			<center>
				<a href="boardDelete.bo?num=${boardInfo.boardNum}">삭제</a></td>
				<a href="boardUpdateForm.bo?num=${boardInfo.boardNum}">수정</a></td>
			</center>
	 	</form>
	</Center>
	</br>
