...
<body style="font-family: 'Do Hyeon', sans-serif;">
	...
	<center>
		<h2 style="font-family: 'Do Hyeon', sans-serif;">장바구니</h2>
		<br/>
		<c:forEach items="${List}" var="List" varStatus="status">
			<table border="1">
				...
				<tr>
					...
					<td><a href="itemDetail.item?num=${List.itemNum}">${List.itemPrice}원</a></td>
					<td><a href="itemDetail.item?num=${List.itemNum}">${List.itemContent}</a></td>
					<td><a href="itemDetail.item?num=${List.itemNum}"><img src="uploadFolder/${List.itemImage}" style="width: 100px; height: 100px;"></a></td>
					<td>
						<a href="#" class="button-w3ls active mt-5" style="display: inline;" onclick="buy()">구매</a>
						<a href="cartDelete.cart?num=${List.itemNum}" class="button-w3ls active mt-5" style="display: inline;">삭제</a>
					</td>
				</tr>
			</table>
		</c:forEach>
